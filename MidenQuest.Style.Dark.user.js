...
(function() {
	...
	addGlobalStyle('#ChatLog > div, #ChatLog > div > span { color: #999 !important; }#ChatLog div:nth-of-type(odd) { background-color: #222; display: inline-block; width: 100%; padding-top: 3px;padding-bottom: 3px;}');
